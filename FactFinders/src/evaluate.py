...
run_name = 'eval_test' #model_id.split("/")[-1].replace("-hf", "").replace("-", "_") + "_evaluation"
...
print(f"Model: {model_id}, Dataset: {training_data_name}, Size: {train_size}")
print(f"Test: Accuracy: {mean_accuracy_t:.4f}, "
      f"Precision: {mean_precision_t:.4f}, "
      f"Recall: {mean_recall_t:.4f}, "
      f"F1 Score: {mean_f1_score_t:.4f}, "
      f"Consistency: {mean_consistency_t:.4f}")

print(f"Dev test: Accuracy: {mean_accuracy_dt:.4f}, "
      f"Precision: {mean_precision_dt:.4f}, "
      f"Recall: {mean_recall_dt:.4f}, "
      f"F1 Score: {mean_f1_score_dt:.4f}, "
      f"Consistency: {mean_consistency_dt:.4f}")
