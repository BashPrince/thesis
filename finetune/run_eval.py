...
class ModelArguments:
    ...
    custom_opt_checkpoint_dir: Optional[str] = field(
        default=None,
        metadata={"help": "Path where the adapter checkpoint is saved."},
    )
...
def main():
    ...
    model.load_adapter(model_args.custom_opt_checkpoint_dir)
